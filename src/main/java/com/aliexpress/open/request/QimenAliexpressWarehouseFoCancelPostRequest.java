...
*/
public class QimenAliexpressWarehouseFoCancelPostRequest extends BaseGopRequest<QimenAliexpressWarehouseFoCancelPostResponse> {
    ...
    public String getApiName() {
        return "/qimen/aliexpress/warehouse/fo/cancel/post";
    }
    @Override
    ...
    @Override
    public Class<QimenAliexpressWarehouseFoCancelPostResponse> getResponseClass() {
        return QimenAliexpressWarehouseFoCancelPostResponse.class;
    }
