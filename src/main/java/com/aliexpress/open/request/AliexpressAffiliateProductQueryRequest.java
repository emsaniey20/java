...
*/
public class AliexpressAffiliateProductQueryRequest extends BaseGopRequest<AliexpressAffiliateProductQueryResponse> {
    ...
    @Override
    public Class<AliexpressAffiliateProductQueryResponse> getResponseClass() {
        return AliexpressAffiliateProductQueryResponse.class;
    }
