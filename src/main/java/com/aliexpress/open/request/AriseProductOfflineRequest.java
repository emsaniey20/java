...
*/
public class AriseProductOfflineRequest extends BaseGopRequest<AriseProductOfflineResponse> {
    ...
    @Override
    public Class<AriseProductOfflineResponse> getResponseClass() {
        return AriseProductOfflineResponse.class;
    }
