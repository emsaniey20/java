...
/**
*  aliexpress.logistics.order.modifyshipment
*/
public class AliexpressLogisticsOrderModifyshipmentRequest extends BaseGopRequest<AliexpressLogisticsOrderModifyshipmentResponse> {

    /** subtrade order list */
    private List<AliexpressLogisticsOrderModifyshipmentAeopSellerShipmentSubTradeOrderDTO> subTradeOrderList;
    /** Old logistics id */
    ...
    public List<AliexpressLogisticsOrderModifyshipmentAeopSellerShipmentSubTradeOrderDTO> getSubTradeOrderList(){
        return this.subTradeOrderList;
    }
    public void setSubTradeOrderList(List<AliexpressLogisticsOrderModifyshipmentAeopSellerShipmentSubTradeOrderDTO> subTradeOrderList){
    ...
    @Override
    public Class<AliexpressLogisticsOrderModifyshipmentResponse> getResponseClass() {
        return AliexpressLogisticsOrderModifyshipmentResponse.class;
    }
