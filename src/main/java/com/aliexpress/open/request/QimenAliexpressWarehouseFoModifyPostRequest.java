...
*/
public class QimenAliexpressWarehouseFoModifyPostRequest extends BaseGopRequest<QimenAliexpressWarehouseFoModifyPostResponse> {
    ...
    public String getApiName() {
        return "/qimen/aliexpress/warehouse/fo/modify/post";
    }
    @Override
    ...
    @Override
    public Class<QimenAliexpressWarehouseFoModifyPostResponse> getResponseClass() {
        return QimenAliexpressWarehouseFoModifyPostResponse.class;
    }
