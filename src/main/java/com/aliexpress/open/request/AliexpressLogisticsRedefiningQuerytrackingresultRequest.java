...
*/
public class AliexpressLogisticsRedefiningQuerytrackingresultRequest extends BaseGopRequest<AliexpressLogisticsRedefiningQuerytrackingresultResponse> {
    ...
    @Override
    public Class<AliexpressLogisticsRedefiningQuerytrackingresultResponse> getResponseClass() {
        return AliexpressLogisticsRedefiningQuerytrackingresultResponse.class;
    }
