...
*  /ds/image/search
*/
public class DsImageSearchRequest extends BaseGopRequest<DsImageSearchResponse> {
    ...
    @Override
    public Class<DsImageSearchResponse> getResponseClass() {
        return DsImageSearchResponse.class;
    }
