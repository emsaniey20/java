...
*/
public class AliexpressLogisticsCreatewarehouseorderRequest extends BaseGopRequest<AliexpressLogisticsCreatewarehouseorderResponse> {

    /** addresses */
    private AliexpressLogisticsCreatewarehouseorderAeopWlDeclareAddressDTO addressDTOs;
    ...
    /** 包裹保额 */
    private AliexpressLogisticsCreatewarehouseorderMoney insuranceCoverage;
    /** 是否同意升级逆向高货值保险 */
    private String isAgreeUpgradeReverseParcelInsure;

    public AliexpressLogisticsCreatewarehouseorderAeopWlDeclareAddressDTO getAddressDTOs(){
        return this.addressDTOs;
    }
    public void setAddressDTOs(AliexpressLogisticsCreatewarehouseorderAeopWlDeclareAddressDTO addressDTOs){
    ...
    public AliexpressLogisticsCreatewarehouseorderMoney getInsuranceCoverage(){
        return this.insuranceCoverage;
    }
    public void setInsuranceCoverage(AliexpressLogisticsCreatewarehouseorderMoney insuranceCoverage){
    ...
    @Override
    public Class<AliexpressLogisticsCreatewarehouseorderResponse> getResponseClass() {
        return AliexpressLogisticsCreatewarehouseorderResponse.class;
    }
