...
/**
*  aliexpress.choice.product.edit
*/
public class AliexpressChoiceProductEditRequest extends BaseGopRequest<AliexpressChoiceProductEditResponse> {
    ...
    /** 商品模型 */
    private AliexpressChoiceProductEditOneStopServiceProductDTO oneStopServiceProductDto;
    ...
    public AliexpressChoiceProductEditOneStopServiceProductDTO getOneStopServiceProductDto(){
        return this.oneStopServiceProductDto;
    }
    public void setOneStopServiceProductDto(AliexpressChoiceProductEditOneStopServiceProductDTO oneStopServiceProductDto){
        this.oneStopServiceProductDto = oneStopServiceProductDto;
        }

    @Override
    public String getApiName() {
        return "aliexpress.choice.product.edit";
    }
    @Override
    ...
    @Override
    public Class<AliexpressChoiceProductEditResponse> getResponseClass() {
        return AliexpressChoiceProductEditResponse.class;
    }
