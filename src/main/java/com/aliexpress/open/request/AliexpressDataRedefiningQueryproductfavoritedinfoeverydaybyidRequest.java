...
*/
public class AliexpressDataRedefiningQueryproductfavoritedinfoeverydaybyidRequest extends BaseGopRequest<AliexpressDataRedefiningQueryproductfavoritedinfoeverydaybyidResponse> {
    ...
    @Override
    public Class<AliexpressDataRedefiningQueryproductfavoritedinfoeverydaybyidResponse> getResponseClass() {
        return AliexpressDataRedefiningQueryproductfavoritedinfoeverydaybyidResponse.class;
    }
