...
*  arise.product.query
*/
public class AriseProductQueryRequest extends BaseGopRequest<AriseProductQueryResponse> {

    /** 渠道seller id （可以在这个API中查询：global.seller.relation.query） */
    private Long channelSellerId;
    /** 渠道商品id */
    private Long productId;
    /** 渠道（可以在这个API中查询：global.seller.relation.query）。目前接口只支持 ARISE_ES */
    ...
    @Override
    public Class<AriseProductQueryResponse> getResponseClass() {
        return AriseProductQueryResponse.class;
    }
