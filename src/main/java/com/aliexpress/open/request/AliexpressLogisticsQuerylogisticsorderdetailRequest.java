...
*/
public class AliexpressLogisticsQuerylogisticsorderdetailRequest extends BaseGopRequest<AliexpressLogisticsQuerylogisticsorderdetailResponse> {
    ...
    @Override
    public Class<AliexpressLogisticsQuerylogisticsorderdetailResponse> getResponseClass() {
        return AliexpressLogisticsQuerylogisticsorderdetailResponse.class;
    }
