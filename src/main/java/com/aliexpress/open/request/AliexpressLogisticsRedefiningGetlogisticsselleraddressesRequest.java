...
*/
public class AliexpressLogisticsRedefiningGetlogisticsselleraddressesRequest extends BaseGopRequest<AliexpressLogisticsRedefiningGetlogisticsselleraddressesResponse> {
    ...
    @Override
    public Class<AliexpressLogisticsRedefiningGetlogisticsselleraddressesResponse> getResponseClass() {
        return AliexpressLogisticsRedefiningGetlogisticsselleraddressesResponse.class;
    }
