...
public class AliexpressPostproductRedefiningEditaeproductAeopAEProductSKU implements Serializable {
    private static final long serialVersionUID = 1L;
        /** SKU属性信息 */
                @ApiListField("aeop_s_k_u_property")
            private List<AliexpressPostproductRedefiningEditaeproductAeopSKUProperty> aeopSKUProperty;
        ...
        /** sku分国家的日常促销价 */
            ...
            private List<AliexpressPostproductRedefiningEditaeproductAeopSKUNationalDiscountPrice> aeopSKUNationalDiscountPrice;
        /** sku日常促销价 */
        ...
        public List<AliexpressPostproductRedefiningEditaeproductAeopSKUProperty> getAeopSKUProperty() {
    return this.aeopSKUProperty;
    }
    public void setAeopSKUProperty(List<AliexpressPostproductRedefiningEditaeproductAeopSKUProperty> aeopSKUProperty) {
    ...
    this.skuStock = skuStock;
        ...
        public List<AliexpressPostproductRedefiningEditaeproductAeopSKUNationalDiscountPrice> getAeopSKUNationalDiscountPrice() {
    return this.aeopSKUNationalDiscountPrice;
    }
    public void setAeopSKUNationalDiscountPrice(List<AliexpressPostproductRedefiningEditaeproductAeopSKUNationalDiscountPrice> aeopSKUNationalDiscountPrice) {
