...
public class DsOrderListTrafficOrderResultDTO implements Serializable {
    private static final long serialVersionUID = 1L;
        ...
        /** orders */
                @ApiListField("orders")
            private List<DsOrderListTrafficOrderEffectDTO> orders;
    ...
    this.currentRecordCount = currentRecordCount;
        ...
        public List<DsOrderListTrafficOrderEffectDTO> getOrders() {
    return this.orders;
    }
    public void setOrders(List<DsOrderListTrafficOrderEffectDTO> orders) {
    this.orders = orders;
    }
