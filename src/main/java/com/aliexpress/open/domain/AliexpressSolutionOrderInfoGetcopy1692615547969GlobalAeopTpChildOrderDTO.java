...
public class AliexpressSolutionOrderInfoGetcopy1692615547969GlobalAeopTpChildOrderDTO implements Serializable {
    private static final long serialVersionUID = 1L;
        ...
        /** order amount */
            ...
            private AliexpressSolutionOrderInfoGetcopy1692615547969GlobalMoneyStr initOrderAmt;
        /** child issue info */
                @ApiField("child_issue_info")
            private AliexpressSolutionOrderInfoGetcopy1692615547969GlobalAeopTpIssueInfoDTO childIssueInfo;
        ...
        /** product price */
            ...
            private AliexpressSolutionOrderInfoGetcopy1692615547969GlobalMoneyStr productPrice;
        /** product name */
        ...
        /** discount amount of child order */
            ...
            private AliexpressSolutionOrderInfoGetcopy1692615547969GlobalMoneyStr childOrderDiscountInfo;
        /** An amount to adjust the product price on, for example, if the seller wants to give buyer a personal discount by the "Adjust price"  button in order management backend. */
            ...
            private AliexpressSolutionOrderInfoGetcopy1692615547969GlobalMoneyStr childOrderAdjustAmount;
        /** discount detail list for each child order */
                @ApiListField("child_order_discount_detail_list")
            private List<AliexpressSolutionOrderInfoGetcopy1692615547969GlobalAeopTpSaleDiscountInfo> childOrderDiscountDetailList;
    ...
    this.afflicateFeeRate = afflicateFeeRate;
        ...
        public AliexpressSolutionOrderInfoGetcopy1692615547969GlobalMoneyStr getInitOrderAmt() {
    return this.initOrderAmt;
    }
    public void setInitOrderAmt(AliexpressSolutionOrderInfoGetcopy1692615547969GlobalMoneyStr initOrderAmt) {
    this.initOrderAmt = initOrderAmt;
    }
        public AliexpressSolutionOrderInfoGetcopy1692615547969GlobalAeopTpIssueInfoDTO getChildIssueInfo() {
    return this.childIssueInfo;
    }
    public void setChildIssueInfo(AliexpressSolutionOrderInfoGetcopy1692615547969GlobalAeopTpIssueInfoDTO childIssueInfo) {
    ...
    this.childOrderId = childOrderId;
        ...
        public AliexpressSolutionOrderInfoGetcopy1692615547969GlobalMoneyStr getProductPrice() {
    return this.productPrice;
    }
    public void setProductPrice(AliexpressSolutionOrderInfoGetcopy1692615547969GlobalMoneyStr productPrice) {
    ...
    this.logisticsWarehouseType = logisticsWarehouseType;
        ...
        public AliexpressSolutionOrderInfoGetcopy1692615547969GlobalMoneyStr getChildOrderDiscountInfo() {
    return this.childOrderDiscountInfo;
    }
    public void setChildOrderDiscountInfo(AliexpressSolutionOrderInfoGetcopy1692615547969GlobalMoneyStr childOrderDiscountInfo) {
    this.childOrderDiscountInfo = childOrderDiscountInfo;
    }
        public AliexpressSolutionOrderInfoGetcopy1692615547969GlobalMoneyStr getChildOrderAdjustAmount() {
    return this.childOrderAdjustAmount;
    }
    public void setChildOrderAdjustAmount(AliexpressSolutionOrderInfoGetcopy1692615547969GlobalMoneyStr childOrderAdjustAmount) {
    this.childOrderAdjustAmount = childOrderAdjustAmount;
    }
        public List<AliexpressSolutionOrderInfoGetcopy1692615547969GlobalAeopTpSaleDiscountInfo> getChildOrderDiscountDetailList() {
    return this.childOrderDiscountDetailList;
    }
    public void setChildOrderDiscountDetailList(List<AliexpressSolutionOrderInfoGetcopy1692615547969GlobalAeopTpSaleDiscountInfo> childOrderDiscountDetailList) {
