...
public class GlobalProductCreateProductSKU implements Serializable {
    private static final long serialVersionUID = 1L;
        ...
        /** 销售属性模块 */
            ...
            private List<GlobalProductCreateSKUProperty> skuPropertyList;
        /** sku价格  	 */
                @ApiField("sku_price")
            private String skuPrice;
        /** sku库存，channel_sku_list中的库存加和 */
                @ApiField("sku_stock")
            private Long skuStock;
        /** 渠道价格库存信息。 */
                @ApiListField("channel_sku_list")
            private List<GlobalProductCreateCspChannelSkuApiDTO> channelSkuList;
        /** sku套图 */
    ...
    this.skuDiscountPrice = skuDiscountPrice;
        ...
        public List<GlobalProductCreateSKUProperty> getSkuPropertyList() {
    return this.skuPropertyList;
    }
    public void setSkuPropertyList(List<GlobalProductCreateSKUProperty> skuPropertyList) {
    ...
    this.skuStock = skuStock;
        ...
        public List<GlobalProductCreateCspChannelSkuApiDTO> getChannelSkuList() {
    return this.channelSkuList;
    }
    public void setChannelSkuList(List<GlobalProductCreateCspChannelSkuApiDTO> channelSkuList) {
