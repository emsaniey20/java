...
public class AliexpressPostproductRedefiningPostmultilanguageaeproductAeopAEProductSKU implements Serializable {
    private static final long serialVersionUID = 1L;
        ...
        /** SKU属性信息 */
            ...
            private List<AliexpressPostproductRedefiningPostmultilanguageaeproductAeopSKUProperty> aeopSKUProperty;
        /** sku日常促销价 */
                @ApiField("sku_discount_price")
            private String skuDiscountPrice;
        /** sku分国家的日常促销价 */
                @ApiListField("aeop_s_k_u_national_discount_price")
            private List<AliexpressPostproductRedefiningPostmultilanguageaeproductAeopSKUNationalDiscountPrice> aeopSKUNationalDiscountPrice;
        /** 供应链条码，非供应链仓库发布不要填写 */
                @ApiField("barcode")
    ...
    this.skuStock = skuStock;
        ...
        public List<AliexpressPostproductRedefiningPostmultilanguageaeproductAeopSKUProperty> getAeopSKUProperty() {
    return this.aeopSKUProperty;
    }
    public void setAeopSKUProperty(List<AliexpressPostproductRedefiningPostmultilanguageaeproductAeopSKUProperty> aeopSKUProperty) {
    ...
    this.skuDiscountPrice = skuDiscountPrice;
        ...
        public List<AliexpressPostproductRedefiningPostmultilanguageaeproductAeopSKUNationalDiscountPrice> getAeopSKUNationalDiscountPrice() {
    return this.aeopSKUNationalDiscountPrice;
    }
    public void setAeopSKUNationalDiscountPrice(List<AliexpressPostproductRedefiningPostmultilanguageaeproductAeopSKUNationalDiscountPrice> aeopSKUNationalDiscountPrice) {
