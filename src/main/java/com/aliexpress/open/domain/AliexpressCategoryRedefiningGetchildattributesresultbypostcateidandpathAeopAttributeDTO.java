...
public class AliexpressCategoryRedefiningGetchildattributesresultbypostcateidandpathAeopAttributeDTO implements Serializable {
    private static final long serialVersionUID = 1L;
        /** 当前属性是否支持自定义枚举类型属性值。 web页面展示为“请输入或从列表选择” */
                @ApiField("support_enum_input")
            private Boolean supportEnumInput;
        /** 发布属性展现样式。list_box：下拉列表，input：输入框，input_int：输入数字，input_string：输入文本，check_box：多选框，radio：单选，other，group_table：check_box 属性含有子属性，group_item：check_box 多选子属性，unit：单位，interval：区间输入框 */
        ...
        /** 发布属性单位 */
                @ApiListField("units")
            private List<AliexpressCategoryRedefiningGetchildattributesresultbypostcateidandpathAeopUnit> units;
        /** 发布属性值 */
                @ApiListField("values")
            private List<AliexpressCategoryRedefiningGetchildattributesresultbypostcateidandpathAeopAttrValueDTO> values;
    ...
    this.spec = spec;
        ...
        public List<AliexpressCategoryRedefiningGetchildattributesresultbypostcateidandpathAeopUnit> getUnits() {
    return this.units;
    }
    public void setUnits(List<AliexpressCategoryRedefiningGetchildattributesresultbypostcateidandpathAeopUnit> units) {
    this.units = units;
    }
        public List<AliexpressCategoryRedefiningGetchildattributesresultbypostcateidandpathAeopAttrValueDTO> getValues() {
    return this.values;
    }
    public void setValues(List<AliexpressCategoryRedefiningGetchildattributesresultbypostcateidandpathAeopAttrValueDTO> values) {
    this.values = values;
    }
