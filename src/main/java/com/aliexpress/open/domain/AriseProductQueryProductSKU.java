...
public class AriseProductQueryProductSKU implements Serializable {
    private static final long serialVersionUID = 1L;
        ...
        /** 销售属性模块 */
            ...
            private List<AriseProductQuerySKUProperty> skuPropertyList;
        /** eanCode */
                @ApiField("ean_code")
    ...
    this.skuDiscountPrice = skuDiscountPrice;
        ...
        public List<AriseProductQuerySKUProperty> getSkuPropertyList() {
    return this.skuPropertyList;
    }
    public void setSkuPropertyList(List<AriseProductQuerySKUProperty> skuPropertyList) {
