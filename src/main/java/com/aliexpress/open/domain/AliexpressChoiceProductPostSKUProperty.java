...
public class AliexpressChoiceProductPostSKUProperty implements Serializable {
    private static final long serialVersionUID = 1L;
        /** 销售属性值 */
                @ApiField("sku_property_value")
            private String skuPropertyValue;
        /** 无效字段，全托管商品已经停止使用，不需要传。女装类目sku套图,3:4图片,图片数量限制 : 3到6张图片。女装(200000345)下的叶子类目必传参数 */
