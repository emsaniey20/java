...
public class AriseProductCreateProductSKU implements Serializable {
    private static final long serialVersionUID = 1L;
        ...
        /** sku销售属性模块 可以从类目属性查询接口查询到类目下对应的 属性id和属性值id */
            ...
            private List<AriseProductCreateSKUProperty> skuPropertyList;
        /** eanCode */
                @ApiField("ean_code")
        ...
        /** sku状态，可选值为:上架 active, 下架 inactive */
                @ApiField("status")
    ...
    this.skuDiscountPrice = skuDiscountPrice;
        ...
        public List<AriseProductCreateSKUProperty> getSkuPropertyList() {
    return this.skuPropertyList;
    }
    public void setSkuPropertyList(List<AriseProductCreateSKUProperty> skuPropertyList) {
