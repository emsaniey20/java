...
public class AriseCategoryAttributesListAriseAttributeDTO implements Serializable {
    private static final long serialVersionUID = 1L;
        /** 属性值列表 */
                @ApiListField("values")
            private List<AriseCategoryAttributesListBaseAttributeValueDTO> values;
        /** 是否是sku销售属性 */
        ...
        public List<AriseCategoryAttributesListBaseAttributeValueDTO> getValues() {
    return this.values;
    }
    public void setValues(List<AriseCategoryAttributesListBaseAttributeValueDTO> values) {
    this.values = values;
    }
