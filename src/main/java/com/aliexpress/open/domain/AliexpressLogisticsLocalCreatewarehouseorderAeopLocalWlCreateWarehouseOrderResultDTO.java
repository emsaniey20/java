...
public class AliexpressLogisticsLocalCreatewarehouseorderAeopLocalWlCreateWarehouseOrderResultDTO implements Serializable {
    private static final long serialVersionUID = 1L;
        /** 首公里揽收模式 */
                @ApiField("first_mile_mode")
            private String firstMileMode;
        /** 创建时错误码(1表示无错误) */
                @ApiField("error_code")
        ...
        public String getFirstMileMode() {
    return this.firstMileMode;
    }
    public void setFirstMileMode(String firstMileMode) {
    this.firstMileMode = firstMileMode;
    }
