...
public class AliexpressPostproductRedefiningPostmultilanguageaeproductMultilanguageAeopAEProduct implements Serializable {
    private static final long serialVersionUID = 1L;
        /** 商品分国家定价规则数据，建议使用新格式，请参考：https://developers.aliexpress.com/doc.htm?docId=109575&docType=1 */
            ...
            private AliexpressPostproductRedefiningPostmultilanguageaeproductAeopNationalQuoteConfiguration aeopNationalQuoteConfiguration;
        ...
        /** 多语言详描，长度不能超过90000个字符。 */
                @ApiField("multilanguage_detail")
            private String multilanguageDetail;
        /** 多语言标题，长度不能超过218个字符。 */
                @ApiField("multilanguage_subject")
        ...
        /** 是否使用自动翻译，如果带上这个参数，则localeName必须为ru_RU，并且会自动把多语言标题和描述通过机器翻译自动翻译成英文，覆盖传人的英文描述和标题里面 */
                @ApiField("use_auto_trans")
            private Boolean useAutoTrans;
        ...
        /** 商品多媒体信息，该属性主要包含商品的视频列表 */
            ...
            private AliexpressPostproductRedefiningPostmultilanguageaeproductAeopAEMultimedia aeopAEMultimedia;
        /** 产品属性，以json格式进行封装后提交。参看aeopAeProductPropertys数据结构。此字段是否必填，需从类目接口getChildAttributesResultByPostCateIdAndPath获取（即获取到的required来判断属性是否必填），该项只输入普通类目属性数据，不可输入sku类目属性。 对于类目属性包含子类目属性的情况，此处不确认父属性和子属性，即选择任何属性，都以该对象提交。 对于一个属性多个选中值的情况，以多个该对象存放。 其中"attrNameId","attrValueId"为整型(Integer), "attrName", "attrValue"为字符串类型(String)。 1. 当设置一些系统属性时，如果类目自定义了一些候选值，只需要提供"attrNameId"和"attrValueId"即可。例如：{"attrNameId":494, "attrValueId":284}。 2. 当设置一些需要手工输入属性内容时，只需要提供"attrNameId"和"attrValue"即可。例如：{"attrNameId": 1000, "attrValue": "test"} 3. 当设置自定义属性时，需要提供"attrName"和"attrValue"即可。例如: {"attrName": "Color", "attrValue": "red"} 4. 当设置一个Other属性时，需要提供"attrNameId", "attrValueId", "attrValue"三个参数。例如：{"attrNameId": 1000, "attrValueId": 4, "attrValue": "Other Value"}。 */
            ...
            private List<AliexpressPostproductRedefiningPostmultilanguageaeproductAeopAeProductProperty> aeopAeProductPropertys;
        /** 商品的SKU信息，列表类型，以json格式来表达。参看aeopAeProductSKUs数据结构。特别提示：新增SKU实际可售库存属性ipmSkuStock，该属性值的合理取值范围为0~999999，如该商品有SKU时，请确保至少有一个SKU是有货状态，也就是ipmSkuStock取值是1~999999，在整个商品纬度库存值的取值范围是1~999999。 */
            ...
            private List<AliexpressPostproductRedefiningPostmultilanguageaeproductAeopAEProductSKU> aeopAeProductSKUs;
    
        public AliexpressPostproductRedefiningPostmultilanguageaeproductAeopNationalQuoteConfiguration getAeopNationalQuoteConfiguration() {
    return this.aeopNationalQuoteConfiguration;
    }
    public void setAeopNationalQuoteConfiguration(AliexpressPostproductRedefiningPostmultilanguageaeproductAeopNationalQuoteConfiguration aeopNationalQuoteConfiguration) {
    ...
    return this.multilanguageDetail;
    }
    ...
    return this.multilanguageSubject;
    }
    ...
    this.summary = summary;
        ...
        public Boolean getUseAutoTrans() {
    return this.useAutoTrans;
    }
    public void setUseAutoTrans(Boolean useAutoTrans) {
    ...
    this.addWeight = addWeight;
        ...
        public AliexpressPostproductRedefiningPostmultilanguageaeproductAeopAEMultimedia getAeopAEMultimedia() {
    return this.aeopAEMultimedia;
    }
    public void setAeopAEMultimedia(AliexpressPostproductRedefiningPostmultilanguageaeproductAeopAEMultimedia aeopAEMultimedia) {
    this.aeopAEMultimedia = aeopAEMultimedia;
    }
        public List<AliexpressPostproductRedefiningPostmultilanguageaeproductAeopAeProductProperty> getAeopAeProductPropertys() {
    return this.aeopAeProductPropertys;
    }
    public void setAeopAeProductPropertys(List<AliexpressPostproductRedefiningPostmultilanguageaeproductAeopAeProductProperty> aeopAeProductPropertys) {
    this.aeopAeProductPropertys = aeopAeProductPropertys;
    }
        public List<AliexpressPostproductRedefiningPostmultilanguageaeproductAeopAEProductSKU> getAeopAeProductSKUs() {
    return this.aeopAeProductSKUs;
    }
    public void setAeopAeProductSKUs(List<AliexpressPostproductRedefiningPostmultilanguageaeproductAeopAEProductSKU> aeopAeProductSKUs) {
