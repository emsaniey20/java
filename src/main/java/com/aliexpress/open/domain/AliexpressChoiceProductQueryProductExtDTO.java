...
public class AliexpressChoiceProductQueryProductExtDTO implements Serializable {
    private static final long serialVersionUID = 1L;
        /** 资质信息 */
                @ApiListField("aeop_qualification_struct_list")
            private List<AliexpressChoiceProductQueryAeopQualificationStructDTO> aeopQualificationStructList;
        ...
        public List<AliexpressChoiceProductQueryAeopQualificationStructDTO> getAeopQualificationStructList() {
    return this.aeopQualificationStructList;
    }
    public void setAeopQualificationStructList(List<AliexpressChoiceProductQueryAeopQualificationStructDTO> aeopQualificationStructList) {
