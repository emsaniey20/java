...
public class AliexpressPostproductRedefiningFindaeproductbyidAeopAEProductSKU implements Serializable {
    private static final long serialVersionUID = 1L;
        /** Sku属性对象list，允许1-3个sku属性对象，按sku属性顺序排放。sku属性从类目属性接口getAttributesResultByCateId获取。该项值输入sku属性，不能输入普通类目属性。注意，sku属性是有顺序的，必须按照顺序存放。 */
            ...
            private List<AliexpressPostproductRedefiningFindaeproductbyidAeopSKUProperty> aeopSKUPropertyList;
        ...
        /** sku分国家的日常促销价 */
            ...
            private List<AliexpressPostproductRedefiningFindaeproductbyidAeopSKUNationalDiscountPrice> aeopSKUNationalDiscountPriceList;
        /** sku日常促销价 */
        ...
        public List<AliexpressPostproductRedefiningFindaeproductbyidAeopSKUProperty> getAeopSKUPropertyList() {
    return this.aeopSKUPropertyList;
    }
    public void setAeopSKUPropertyList(List<AliexpressPostproductRedefiningFindaeproductbyidAeopSKUProperty> aeopSKUPropertyList) {
    ...
    this.barcode = barcode;
        ...
        public List<AliexpressPostproductRedefiningFindaeproductbyidAeopSKUNationalDiscountPrice> getAeopSKUNationalDiscountPriceList() {
    return this.aeopSKUNationalDiscountPriceList;
    }
    public void setAeopSKUNationalDiscountPriceList(List<AliexpressPostproductRedefiningFindaeproductbyidAeopSKUNationalDiscountPrice> aeopSKUNationalDiscountPriceList) {
