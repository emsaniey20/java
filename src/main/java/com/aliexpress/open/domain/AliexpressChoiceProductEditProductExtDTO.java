...
public class AliexpressChoiceProductEditProductExtDTO implements Serializable {
    private static final long serialVersionUID = 1L;
        /** 资质信息 */
                @ApiListField("aeop_qualification_struct_list")
            private List<AliexpressChoiceProductEditAeopQualificationStructDTO> aeopQualificationStructList;
        ...
        public List<AliexpressChoiceProductEditAeopQualificationStructDTO> getAeopQualificationStructList() {
    return this.aeopQualificationStructList;
    }
    public void setAeopQualificationStructList(List<AliexpressChoiceProductEditAeopQualificationStructDTO> aeopQualificationStructList) {
