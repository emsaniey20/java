...
public class GlobalProductQueryProductSKU implements Serializable {
    private static final long serialVersionUID = 1L;
        ...
        /** 销售属性模块 */
            ...
            private List<GlobalProductQuerySKUProperty> skuPropertyList;
        /** sku价格 */
                @ApiField("sku_price")
        ...
        /** 渠道价格库存信息。 新发未铺货成功的统一商品不会返回channel_sku_list 。 当channel_sku_list不返回时说明当前统一商品的渠道商品铺货失败或不存在。 需要先完成铺货 */
                @ApiListField("channel_sku_list")
            private List<GlobalProductQueryCspChannelSkuApiDTO> channelSkuList;
        /** sku套图 */
    ...
    this.skuDiscountPrice = skuDiscountPrice;
        ...
        public List<GlobalProductQuerySKUProperty> getSkuPropertyList() {
    return this.skuPropertyList;
    }
    public void setSkuPropertyList(List<GlobalProductQuerySKUProperty> skuPropertyList) {
    ...
    this.skuStock = skuStock;
        ...
        public List<GlobalProductQueryCspChannelSkuApiDTO> getChannelSkuList() {
    return this.channelSkuList;
    }
    public void setChannelSkuList(List<GlobalProductQueryCspChannelSkuApiDTO> channelSkuList) {
