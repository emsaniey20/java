...
public class AliexpressAffiliateProductdetailGetTrafficProductDTO implements Serializable {
    private static final long serialVersionUID = 1L;
        /** App sale price in target currency */
                @ApiField("app_sale_price")
            private String appSalePrice;
        /** currency of App sale price */
        ...
        /** code */
            ...
            private AliexpressAffiliateProductdetailGetPromoCodeDTO promoCodeInfo;
    ...
    this.targetSalePriceCurrency = targetSalePriceCurrency;
        ...
        public AliexpressAffiliateProductdetailGetPromoCodeDTO getPromoCodeInfo() {
    return this.promoCodeInfo;
    }
    public void setPromoCodeInfo(AliexpressAffiliateProductdetailGetPromoCodeDTO promoCodeInfo) {
