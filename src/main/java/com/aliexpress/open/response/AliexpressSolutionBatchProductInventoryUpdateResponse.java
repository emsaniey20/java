...
*/
public class AliexpressSolutionBatchProductInventoryUpdateResponse extends IopResponse {
    ...
    /** update failed list */
        ...
        private List<AliexpressSolutionBatchProductInventoryUpdateSynchronizeProductResponseDTO> updateFailedList;
    /** update succesful list */
        @ApiListField("update_successful_list")
        private List<AliexpressSolutionBatchProductInventoryUpdateSynchronizeProductResponseDTO> updateSuccessfulList;
...
public List<AliexpressSolutionBatchProductInventoryUpdateSynchronizeProductResponseDTO> getUpdateFailedList(){
return this.updateFailedList;
}
public void setUpdateFailedList(List<AliexpressSolutionBatchProductInventoryUpdateSynchronizeProductResponseDTO> updateFailedList){
    this.updateFailedList = updateFailedList;
}
public List<AliexpressSolutionBatchProductInventoryUpdateSynchronizeProductResponseDTO> getUpdateSuccessfulList(){
return this.updateSuccessfulList;
}
public void setUpdateSuccessfulList(List<AliexpressSolutionBatchProductInventoryUpdateSynchronizeProductResponseDTO> updateSuccessfulList){
